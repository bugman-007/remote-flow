...
- **JD-3 (P0)** Validation: trimmed length between `min_jd_chars` (default 50) and `max_jd_chars` (default 20,000); whitespace-only is rejected; error shown inline without clearing the box.
